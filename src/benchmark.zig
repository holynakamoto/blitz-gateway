...
// NOTE: This benchmark is disabled - old QUIC crypto code was removed.
// TODO: Re-implement using msquic API
//═══════════════════════════════════════════════════════════════════════════════
...
fn benchmarkHttp3Connection(state: *WorkerState) void {
    // TODO: Re-implement using msquic API
    // HTTP/3 benchmark disabled - old QUIC crypto code was removed
    state.failed_requests += 1;
    return;
}
